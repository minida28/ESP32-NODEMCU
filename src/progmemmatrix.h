...
const char NO_MEAN_0_Str[] PROGMEM = "NO_MEAN";
const char POWERON_RESET_Str[] PROGMEM = "Vbat power on reset";
const char NO_MEAN_1_Str[] PROGMEM = "NO_MEAN";
const char SW_RESET_Str[] PROGMEM = "Software reset digital core";
const char OWDT_RESET_Str[] PROGMEM = "Legacy watch dog reset digital core";
const char DEEPSLEEP_RESET_Str[] PROGMEM = "Deep Sleep reset digital core";
const char SDIO_RESET_Str[] PROGMEM = "Reset by SLC module, reset digital core";
const char TG0WDT_SYS_RESET_Str[] PROGMEM = "Timer Group0 Watch dog reset digital core";
const char TG1WDT_SYS_RESET_Str[] PROGMEM = "Timer Group1 Watch dog reset digital core";
const char RTCWDT_SYS_RESET_Str[] PROGMEM = "RTC Watch dog Reset digital core";
const char INTRUSION_RESET_Str[] PROGMEM = "Instrusion tested to reset CPU";
const char TGWDT_CPU_RESET_Str[] PROGMEM = "Time Group reset CPU";
const char SW_CPU_RESET_Str[] PROGMEM = "Software reset CPU";
const char RTCWDT_CPU_RESET_Str[] PROGMEM = "RTC Watch dog Reset CPU";
const char EXT_CPU_RESET_Str[] PROGMEM = "for APP CPU, reseted by PRO CPU";
const char RTCWDT_BROWN_OUT_RESET_Str[] PROGMEM = "Reset when the vdd voltage is not stable";
const char RTCWDT_RTC_RESET_Str[] PROGMEM = "RTC Watch dog reset digital core and rtc module";

const char *const resetreason_P[] PROGMEM =
    {
        NO_MEAN_0_Str,
        POWERON_RESET_Str,
        NO_MEAN_1_Str,
        ...
        DEEPSLEEP_RESET_Str,
        SDIO_RESET_Str,
        TG0WDT_SYS_RESET_Str,
        TG1WDT_SYS_RESET_Str,
        RTCWDT_SYS_RESET_Str,
        INTRUSION_RESET_Str,
        TGWDT_CPU_RESET_Str,
        SW_CPU_RESET_Str,
        RTCWDT_CPU_RESET_Str,
        EXT_CPU_RESET_Str,
        RTCWDT_BROWN_OUT_RESET_Str,
        RTCWDT_RTC_RESET_Str};
...
const char pgm_chiprev[] PROGMEM = "chiprev";
...
const char pgm_resetreasoncpu0[] PROGMEM = "resetreasoncpu0";
const char pgm_resetreasoncpu1[] PROGMEM = "resetreasoncpu1";
